...
@Component({
  selector: 'app-image-cropper-example',
  templateUrl: './image-cropper-example.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    StyleRenderer
  ],
  styleUrls: ['./image-cropper-example.component.scss']
})
export class ImageCropperExampleComponent implements WithStyles, AfterViewInit {
